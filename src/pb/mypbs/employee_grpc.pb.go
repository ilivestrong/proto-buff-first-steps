...
type EmployeeServiceClient interface {
	AddEmployee(ctx context.Context, in *EmployeeRequest, opts ...grpc.CallOption) (*AddEmployeeResponse, error)
}
...
func (c *employeeServiceClient) AddEmployee(ctx context.Context, in *EmployeeRequest, opts ...grpc.CallOption) (*AddEmployeeResponse, error) {
	out := new(AddEmployeeResponse)
	err := c.cc.Invoke(ctx, "/crm.EmployeeService/AddEmployee", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EmployeeServiceServer interface {
	AddEmployee(context.Context, *EmployeeRequest) (*AddEmployeeResponse, error)
...
func (UnimplementedEmployeeServiceServer) AddEmployee(context.Context, *EmployeeRequest) (*AddEmployeeResponse, error) {
...
func _EmployeeService_AddEmployee_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/crm.EmployeeService/AddEmployee",
	}
...
var EmployeeService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "src/protos/crm/employee.proto",
}
